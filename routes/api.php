...
Route::resource('hechos', 'HechoAPIController');

Route::resource('atropellados', 'AtropelladoAPIController');

Route::get('getColonias',  ['uses' => 'AtropelladoAPIController@getColonias']);
